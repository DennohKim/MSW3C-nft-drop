        ...
        <div className="relative z-10 h-full w-full ">
          <div className="grid h-full grid-cols-1 lg:grid-cols-12">
            ...
            <div className="col-span-1 flex w-full flex-col items-center justify-center space-y-3 lg:col-span-7">
              <div className="flex w-full max-w-xl flex-col gap-4 rounded-xl bg-black/60 px-12 py-6 lg:border lg:border-gray-400 lg:dark:border-gray-800">
                <h2 className="text-lg font-bold tracking-wider text-white xs:text-xl lg:text-2xl">
                  How to claim the NFT
                </h2>
                <p className="text-sm">
                  <span className="pr-2 font-bold">1.</span>Download Metamask
                  wallet from{" "}
                  <a
                  ...
                  on a web browser. Create a wallet address.💸. Secure your
                  private keys.🔒
                </p>
                <p className="text-sm">
                  ...
                  "include testnets" and add it to Metamask. Confirm the chain
                  ID.😎
                </p>
                <p className="text-sm">
                  ...
                  Paste your wallet address and submit to receive some MATIC
                  (test tokens).💰 You are now ready to claim the NFT.🎉
                </p>
              </div>
              <div className="flex w-full max-w-xl flex-col gap-4 rounded-xl bg-black/60 px-12 py-8 lg:border lg:border-gray-400 lg:dark:border-gray-800">
